...
Namespace IssueVision.Data.DbCommandProvider
    Public Interface IDbIssueTypesCommandProvider
        ReadOnly Property IssueTypesDbConnectionHolder() As DbConnectionHolder
        ReadOnly Property DbConnectionName As String
        Function GetGetDataDbCommand() As IDbCommand
        Function GetUpdateDbCommand( ByVal issueTypeID As Byte,  ByVal name As String) As IDbCommand
        Function GetInsertDbCommand( ByVal issueTypeID As Byte,  ByVal name As String) As IDbCommand
        Function GetDeleteDbCommand( ByVal issueTypeID As Byte) As IDbCommand
