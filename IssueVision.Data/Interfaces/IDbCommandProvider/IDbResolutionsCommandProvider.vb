...
Namespace IssueVision.Data.DbCommandProvider
    Public Interface IDbResolutionsCommandProvider
        ReadOnly Property ResolutionsDbConnectionHolder() As DbConnectionHolder
        ReadOnly Property DbConnectionName As String
        Function GetGetDataDbCommand() As IDbCommand
        Function GetUpdateDbCommand( ByVal resolutionID As Byte,  ByVal name As String) As IDbCommand
        Function GetInsertDbCommand( ByVal resolutionID As Byte,  ByVal name As String) As IDbCommand
        Function GetDeleteDbCommand( ByVal resolutionID As Byte) As IDbCommand
